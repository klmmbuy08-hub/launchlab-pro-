...
import { Plus, Settings, Zap, AlertCircle } from 'lucide-react'
...
export default function IntegrationsPage() {
  ...
  const statusColors = {
    ...
    disconnected: 'bg-neutral-500/10 text-[#6B7280] border-neutral-500/20',
    error: 'bg-red-500/10 text-red-400 border-red-500/20',
  }

  const categories = ['Social Media', 'CRM', 'Automation', 'Analytics']
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#6B7280] mt-1">Connect with your favorite tools</p>
        </div>
        <Button size="lg"><Plus className="w-4 h-4 mr-2" />Browse Apps</Button>
      </div>
            ...
            <div key={category}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {categoryIntegrations.map(integration => (
                  <Card key={integration.id} className={`bg-[#171717] border border-[#262626] cursor-pointer hover:border-neutral-700 transition`}>
